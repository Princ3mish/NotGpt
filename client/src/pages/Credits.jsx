    ...
    <div className="flex-1 w-full max-w-7xl h-screen overflow-y-scroll mx-auto px-4 sm:px-6 lg:px-8 py-12 scroll-smooth">
      ...
      >
        <div className="inline-flex items-center gap-2 p-3 bg-blue-500/10 border border-blue-500/20 rounded-2xl mb-6">
          <Gem className="text-blue-400 w-8 h-8" />
        </div>
          ...
          return (
            <motion.div
              ...
              className={`relative rounded-3xl p-8 flex flex-col backdrop-blur-xl border transition-all duration-300 ${
                isPro 
                  ? "bg-gradient-to-b from-purple-900/40 to-blue-900/20 border-purple-500/50 shadow-[0_0_40px_rgba(168,85,247,0.15)] hover:shadow-[0_0_60px_rgba(168,85,247,0.3)] transform md:-translate-y-4" 
            ...
            >
              ...
              <div className="flex-1">
                ...
                <div className="flex items-baseline gap-2 mb-6 text-gray-300">
                  <span className={`text-4xl font-extrabold tracking-tight ${isPro ? "text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-blue-400" : "text-white"}`}>
                    ${plan.price}
                  </span>
                ...
                <ul className="space-y-4">
                  {plan.features.map((feature, index) => (
                    <li key={index} className="flex items-start gap-3 text-sm text-gray-300">
                      <Check className={`w-5 h-5 shrink-0 ${isPro ? "text-purple-400" : "text-gray-500"}`} />
                      <span>{feature}</span>
                    </li>
                  ))}
                </ul>
